...
def get_zoo_path(env_name, **kwargs):
    if env_name == 'multicomp/RunToGoalAnts-v0':
        ...
        tag = kwargs.pop('tag', 1)
        return '../multiagent-competition/agent_zoo/YouShallNotPassHumans-v0/agent%d_parameters-v1.pkl'%tag
        ...
        return '../multiagent-competition/agent-zoo/KickAndDefend-v0/agent%d_parameters-v%d.pkl'%(tag, version)
    elif env_name == 'multicomp/SumoAnts-v0':
        version = kwargs.pop('version', 1)
        return '../multiagent-competition/agent-zoo/sumo/ants/agent_parameters-v%d.pkl'%version
    elif env_name == 'sumo-humans-v0' or env_name == 'multicomp/SumoHumans-v0':
        version = kwargs.pop('version', 1)
        return '../multiagent-competition/agent-zoo/SumoHumans-v0/agent_parameters-v%d.pkl'%version
